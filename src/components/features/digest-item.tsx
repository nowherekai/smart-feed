    ...
    <div className="group relative pl-8 border-l-2 border-border/50 hover:border-primary/50 transition-colors py-2">
      ...
      <div className="space-y-3">
        <div className="flex flex-wrap items-center gap-3">
          <h5 className="text-xl font-bold tracking-tight text-foreground">{record.summary.summary}</h5>
        ...
        <ul className="space-y-2">
          {record.summary.paragraphSummaries.map((point, i) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: The summary list is a read-only static list
