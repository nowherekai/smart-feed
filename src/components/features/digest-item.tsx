    ...
    <div className="group relative pl-8 border-l-2 border-border/50 hover:border-primary/50 transition-colors py-2">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-4 pt-2">
          {/* We assume the record might have an original_url or we mimic it */}
          <Link
            href="#"
          ...
          <Tooltip>
            ...
            <TooltipContent className="max-w-md p-4 bg-background border-border shadow-md">
              <p className="text-xs leading-relaxed italic text-muted-foreground">"{record.evidence_snippet}"</p>
            </TooltipContent>
          </Tooltip>
        </div>
      </div>
